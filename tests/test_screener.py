...
def _snapshot(seed: float) -> DecisionSnapshot:
    idx = pd.bdate_range("2024-01-01", "2026-01-02")
    ...
    return DecisionSnapshot(pd.Timestamp("2026-01-05"), pd.Timestamp("2026-01-02"), frame)
